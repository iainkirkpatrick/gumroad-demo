...
function CheckoutPage({
  ...
  if (purchases.length > 0) {
    ...
    return (
      <div className="px-4 lg:px-16 py-4 lg:py-16 flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        <div className="flex flex-col lg:min-w-96 border border-black rounded-md bg-white">
  ...
  return (
    <div className="pl-4 py-4 lg:p-0 flex border-b border-black">
      ...
      <div className="px-4 py-0 lg:p-4 flex justify-between w-full">
        ...
        <div className="flex flex-col items-end justify-between gap-4 lg:gap-0">
          {cartItem.variant_id ? (
          ...
          <div className='flex flex-col lg:flex-row items-end lg:items-center lg:gap-4'>
            {cartItem.product.variants && updateCartItem && (
              ...
              >
                <button
                  className="text-sm underline align-end"
...
function Success ({
  ...
  return (
    <div className="px-4 lg:px-16 py-4 lg:py-16 flex flex-col items-center">
      <div className="flex flex-col bg-white border border-black rounded-md lg:min-w-96">
